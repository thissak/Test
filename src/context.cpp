...
bool Context::Init()
{
    ...
    m_material.albedo = Texture::CreateFromImage(
        Image::Load("./img/rustediron2_basecolor.png").get());
    m_material.roughness = Texture::CreateFromImage(
        Image::Load("./img/rustediron2_roughness.png").get());
    m_material.metallic = Texture::CreateFromImage(
        Image::Load("./img/rustediron2_metallic.png").get());
    m_material.normal = Texture::CreateFromImage(
        Image::Load("./img/rustediron2_normal.png").get());
